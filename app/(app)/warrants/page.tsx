...
export default async function DefenseWarrantsPage() {
  await requireStaffPermission("warrant:view-all")
  ...
  return (
    <main className="flex-1 space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">Review warrant requests and decisions relevant to your cases.</p>
      </div>
      <WarrantList
        warrants={warrants}

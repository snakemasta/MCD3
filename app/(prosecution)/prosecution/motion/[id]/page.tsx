...
export default async function ProsecutionMotionDetailPage({
  params,
}: {
  ...
  return (
    <main className="flex-1 space-y-6 p-6">
      <div className="flex items-center justify-between gap-2">
        ...
        {canEditDraft && (
          <Button render={<Link href={`/prosecution/motion/${id}/edit`} />} variant="outline" size="sm">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          <MotionDetailView
            ...
            caseHref={c ? `/prosecution/cases/${c.id}` : null}
